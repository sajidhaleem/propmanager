  ...
  return (
    <>
      ...
      <div className="app-canvas min-h-[100dvh] lg:p-4">
        ...
        <div className="app-frame grain relative flex h-[100dvh] overflow-hidden lg:h-[calc(100dvh-2rem)]">
          <SideNav />
          <main className="relative z-[1] min-w-0 flex-1 overflow-y-auto scrollbar-thin">
